...
f.HealthBar:SetPoint("RIGHT", UIParent, "CENTER", 0, 0)
...
f.HealthBar2:SetPoint("RIGHT", f.HealthBar, "LEFT", -2, 0)
...
f.HealthBar3:SetPoint("RIGHT", f.HealthBar2, "LEFT", -2, 0)
